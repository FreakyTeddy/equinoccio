...
RedBlackTree::~RedBlackTree() {
  ...
  std::deque<RedBlackTreeNode *> stuffToFree;
...
std::deque<RedBlackTreeNode *> * RedBlackTree::Enumerate(int low, 
							    int high)  {
  std::deque<RedBlackTreeNode *> * enumResultStack = 
    new std::deque<RedBlackTreeNode *>(4);
